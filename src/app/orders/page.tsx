        ...
        {!loading && totalPages > 1 && (
          <div className="flex justify-center mt-8 gap-2">
            <button
              ...
              disabled={page === 1}
              className="px-4 py-2 bg-white border border-gray-200 text-gray-600 rounded-lg hover:bg-gray-50 disabled:opacity-50 transition-colors"
            >
              السابق
            </button>
            <span className="px-4 py-2 flex items-center font-bold text-gray-800 bg-gray-100 rounded-lg">
              {page} / {totalPages}
            </span>
            <button
